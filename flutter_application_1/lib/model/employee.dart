// ignore_for_file: prefer_const_constructors, avoid_print, sized_box_for_whitespace, prefer_const_declarations, use_super_parameters, unnecessary_null_comparison, unused_import, unused_field, sort_child_properties_last, unused_element, use_build_context_synchronously, duplicate_ignore
...
import 'package:flutter_application_1/employee_list_screen.dart';
import 'package:flutter_application_1/model/employee_api.dart';
import 'package:flutter_application_1/screens/employee_addemployes.dart';
        ...
        actions: [
          PopupMenuButton(
            ...
            itemBuilder: (BuildContext context) => [
              ...
              PopupMenuItem(
                onTap: () {
                  // Add code for logout here if needed
                },
                value: 3,
                child: const Text(
                  "Logout",
